...
%-----------------------------------------------------------------------
% Program unit name: canaleveloce
...
% regolato da un serbatoio di monte e da una portata (variabile) a 
% monte, con flussi esterni costanti ed uniformi. It is equivalent to 
% "canalelento" for supercritical free surface flows. Thomas’ algorithm.
% Year: 2004.
%-----------------------------------------------------------------------
